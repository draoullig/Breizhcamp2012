...
ChatRoomServiceClient.prototype.getListeMessage = function() {
  this.send_getListeMessage();
  return this.recv_getListeMessage();
};

ChatRoomServiceClient.prototype.send_getListeMessage = function() {
...
ChatRoomServiceClient.prototype.envoyerMessage = function(message) {
  this.send_envoyerMessage(message);
  this.recv_envoyerMessage();
};

ChatRoomServiceClient.prototype.send_envoyerMessage = function(message) {
...
ChatRoomServiceClient.prototype.enregistrerUtilisateur = function(utilisateur) {
  this.send_enregistrerUtilisateur(utilisateur);
  this.recv_enregistrerUtilisateur();
};

ChatRoomServiceClient.prototype.send_enregistrerUtilisateur = function(utilisateur) {
